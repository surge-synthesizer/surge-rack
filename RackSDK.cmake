...
add_compile_options("$<IF:$<STREQUAL:${CMAKE_OSX_ARCHITECTURES},arm64>,-arch arm64 -march=armv8-a+fp+simd,-march=nehalem>")
add_compile_options("$<$<STREQUAL:${CMAKE_OSX_ARCHITECTURES},x86_64>:-arch x86_64>")
