...
struct SurgePatchPlayer : virtual public SurgeModuleCommon {
    ...
    void updatePatchIdx() {
        ...
        */
        ...
        if( patchInCatIdx == cat.numberOfPatchesInCatgory ) patchInCatIdx--;
    ...
    void process(const typename rack::Module::ProcessArgs &args) override
    {
        ...
        for( int i=0; i<nChan; ++i )
        {
            ...
            if( newVoice )
            {
                ...
                float vel = inputs[VEL_CV].isConnected() ? inputs[VEL_CV].getPolyVoltage(i) * 12.7 : 100;
            ...
            {
                surge_synth->releaseNote(i, noteForChannel[i], 0); // FIXME: Release velocity
                noteForChannel[i] = -1;
            }
    ...
    virtual json_t *dataToJson() override {
        ...
        json_object_set_new( rootJ, "patchCategoryName", json_string(patchInfoCache[0].value.c_str()));
