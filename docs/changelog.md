...
- Make sure the surge FPU guard is in place
- Fix an error with labeling the names of the FX Modulation Parameters
- Move github actions to 2.5.* SDK

## 2.2.3

- Add detune extend panel glyph
- Reset all I/O buffers when initializing an effect
- Fix an uninitialized value in the waveshaper
- Update code copyright notices to 2024
- Modify compile flags to allow builds with some very older compilers
